...
function qtypeorder_showHide(img, hidetext, showtext){
...
function qtypeorder_setExpanded(ids, expanded) {
    ...
    for (var i=0; i<i_max; i++) {
        ...
        if (obj) {
            ...
            if (legend) {
                ...
                img.onclick = qtypeorder_showHide;
...
qtypeorder_setExpanded(['names', 'defaults', 'display'], false);
//]]>